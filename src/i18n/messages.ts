...
const en = {
  ...
  "settings.hintDns": "Fallback DNS · FakeIP · diagnostics",
  ...
  "settings.trayIconSaturn": "Saturn",
  ...
  "settings.coreAssets": "Fetching runtime assets…",
  ...
  "config.mix": "Mix",
  "config.skippedTitle": "{n} nodes were not imported",
  "config.skippedHint":
    "These nodes were skipped by the parser (unsupported protocol/transport etc.). Copy the report and send it to the developer to help support them.",
  "config.skippedCopy": "Copy report",
  "config.skippedUnnamed": "(unnamed)",
  "config.mixOn": "Mix on",
  ...
  "nodes.groupBy": "Group",
  "nodes.groupDefault": "Default",
  "nodes.groupSub": "Subscription",
  "nodes.groupProto": "Protocol",
  ...
  "nodes.collapseAll": "Collapse",
  "nodes.expandAll": "Expand",
  "nodes.favoritesOnly": "Favorites",
  "nodes.favoritesOnlyHint": "Show only favorited nodes",
  "nodes.favorite": "Favorite",
  "nodes.unfavorite": "Unfavorite",
  "nodes.favoriteToggleHint": "Click to favorite / unfavorite",
  ...
  "nodes.detailTls": "TLS",
  "nodes.detailTransport": "Transport",
  "nodes.fProtocol": "Protocol",
  "nodes.fServer": "Server",
  "nodes.fPort": "Port",
  "nodes.fUdp": "UDP relay",
  "nodes.fSub": "Subscription",
  "nodes.fSource": "Source type",
  "nodes.fMethod": "Cipher",
  "nodes.fPassword": "Password",
  "nodes.fUser": "Username",
  "nodes.fAuth": "Auth",
  "nodes.fPlugin": "Plugin",
  "nodes.fPluginOpts": "Plugin options",
  "nodes.fObfs": "Obfs",
  "nodes.fObfsPass": "Obfs password",
  "nodes.fUp": "Upload (Mbps)",
  "nodes.fDown": "Download (Mbps)",
  "nodes.fSkipCert": "Skip cert verify",
  "nodes.fTransportType": "Type",
  ...
  "rules.targetChainShort": "Chain",
  "rules.pickNode": "Node",
  "rules.pickNodePh": "Search node name…",
  "rules.pickedCount": "{n} selected",
  "rules.nodePickEmpty": "No matching nodes",
  "rules.nodeTipInsecure": "cert not verified",
  "rules.nodeTipUdp": "UDP supported",
  "rules.nodeTipUdpNo": "no UDP",
  "rules.nodePoolCount": "{n}-node pool",
  "rules.needNode": "Select a node for this rule",
  "rules.pickChain": "Proxy Chain",
  "rules.chainHopsLabel": "Chain route",
  "rules.chainHopsEmpty": "Pick a chain to see its route here",
  ...
  "rules.batchRouteLabel": "Batch set route",
  "rules.currentRouteHint": "Set's current type: {current}",
  "rules.targetProxyDesc": "All traffic matching this set is sent through the active proxy.",
  "rules.targetDirectDesc": "All traffic matching this set connects directly, bypassing the proxy.",
  "rules.targetBlockDesc": "All traffic matching this set is blocked.",
  "rules.lastUpdated": "Last updated",
  "rules.currentDnsHint": "Current resolver: {current}",
  "rules.mixedSetHint":
    "This set has mixed per-rule routes. Changing it will overwrite all of them.",
  "rules.pickChainPh": "Search chain name…",
  ...
  "dns.remoteDns": "Remote encrypted DNS",
  "dns.remoteDnsDesc": "Empty = built-in 1.1.1.1 / 8.8.8.8",
  "dns.remoteDnsOptions": "Remote DNS servers",
  "dns.remoteDnsBuiltin": "Built-in",
  "dns.remoteDnsCustom": "{n} custom",
  "dns.remoteDnsHint": "One https:// (DoH) URL per line, up to 8. IP-literal endpoints (e.g. https://94.140.14.14/dns-query) avoid bootstrap lookups; domain endpoints bootstrap via domestic DNS. Queries always egress through the proxy.",
  "dns.remoteDnsInvalid": "Only https:// (DoH) URLs are allowed: {v}",
  "dns.remoteDnsMax": "Up to 8 entries",
  ...
  "dns.hijackDesc": "Core handles system DNS (TUN recommended)",
  "dns.defaultResolve": "Fallback resolver",
  "dns.defaultResolveDesc": "Used when no rule matches",
  "dns.cacheDesc": "Fewer repeat lookups",
  ...
  "dns.fakeipOptions": "FakeIP options",
  ...
  "dns.diagDesc": "Live resolution through the core, showing the query path",
  "dns.domainLabel": "Domain",
  "dns.addDomain": "Add",
  "dns.domainPh": "Custom domain",
  "dns.diagRun": "Diagnose",
  "dns.diagRunning": "Diagnosing…",
  "dns.test": "Diagnose this domain",
  "dns.removeDomain": "Remove",
  "dns.colStrategy": "Strategy",
  "dns.stRemote": "Remote",
  "dns.stDomestic": "Domestic",
  "dns.stLocal": "Local",
  "dns.stBlock": "Blocked",
  "dns.stHosts": "Hosts",
  "dns.stFakeip": "FakeIP",
  "dns.matchedLabel": "Matched",
  "dns.serverLabel": "Servers",
  "dns.coreQuery": "Core query",
  "dns.approxTag": "approx",
  "dns.coreRunning": "running",
  "dns.coreStopped": "stopped",
  "dns.leakRiskLocal": "Leak risk: system DNS (plaintext) — queries are observable to the ISP",
  "dns.leakRiskDomestic": "Leak risk: plaintext domestic UDP — queries are observable to the ISP",
...
const zh: Record<MessageKey, string> = {
  ...
  "settings.hintDns": "兜底解析 · FakeIP · 诊断",
  ...
  "config.mix": "Mix",
  "config.skippedTitle": "{n} 个节点未能导入",
  "config.skippedHint":
    "以下节点在解析时被跳过（不支持的协议/传输等）。可复制报告反馈给开发者，帮助后续支持。",
  "config.skippedCopy": "复制报告",
  "config.skippedUnnamed": "（未命名）",
  "config.mixOn": "Mix 开",
  "config.mixOff": "Mix 关",
  ...
  "nodes.groupBy": "分组",
  "nodes.groupDefault": "默认",
  "nodes.groupSub": "订阅",
  "nodes.groupProto": "协议",
  "nodes.groupCountry": "地区",
  "nodes.groupOther": "其他",
  "nodes.groupToggleHint": "点击折叠 / 展开",
  "nodes.groupNoSub": "未分组",
  "nodes.collapseAll": "折叠",
  "nodes.expandAll": "展开",
  "nodes.favoritesOnly": "收藏",
  "nodes.favoritesOnlyHint": "只显示已收藏的节点",
  "nodes.favorite": "收藏",
  "nodes.unfavorite": "取消收藏",
  "nodes.favoriteToggleHint": "点击收藏 / 取消收藏",
  ...
  "nodes.fAuth": "认证",
  "nodes.fPlugin": "插件",
  "nodes.fPluginOpts": "插件参数",
  "nodes.fObfs": "混淆",
  "nodes.fObfsPass": "混淆密码",
  "nodes.fUp": "上行带宽 (Mbps)",
  "nodes.fDown": "下行带宽 (Mbps)",
  "nodes.fSkipCert": "跳过证书验证",
  "nodes.fTransportType": "类型",
  "nodes.testing": "测试中…",
  ...
  "rules.targetChainShort": "链路",
  "rules.pickNode": "节点",
  "rules.pickNodePh": "搜索节点名…",
  "rules.pickedCount": "已选 {n} 个",
  "rules.nodePickEmpty": "无匹配节点",
  "rules.nodeTipInsecure": "证书未校验",
  "rules.nodeTipUdp": "支持 UDP",
  "rules.nodeTipUdpNo": "无 UDP",
  "rules.nodePoolCount": "{n} 节点池",
  "rules.needNode": "请选择一个节点",
  "rules.pickChain": "代理链",
  "rules.chainHopsLabel": "链路走向",
  "rules.chainHopsEmpty": "选择链路后在此显示走向",
  ...
  "rules.batchRouteLabel": "批量设置路由",
  "rules.currentRouteHint": "规则集当前类型：{current}",
  "rules.targetProxyDesc": "匹配此规则集的全部流量都将通过当前代理转发。",
  "rules.targetDirectDesc": "匹配此规则集的全部流量都将跳过代理，直接连接。",
  "rules.targetBlockDesc": "匹配此规则集的全部流量都将被屏蔽。",
  "rules.lastUpdated": "最近更新",
  "rules.currentDnsHint": "当前解析：{current}",
  "rules.mixedSetHint": "当前规则集带有多种规则，如果修改将会整体覆盖。",
  "rules.pickChainPh": "搜索代理链名称…",
  ...
  "dns.finalRemote": "远程",
  "dns.remoteDns": "远程加密 DNS",
  "dns.remoteDnsDesc": "留空使用内置 1.1.1.1 / 8.8.8.8",
  "dns.remoteDnsOptions": "远程 DNS 服务器",
  "dns.remoteDnsBuiltin": "内置",
  "dns.remoteDnsCustom": "自定义 {n} 条",
  "dns.remoteDnsHint": "每行一个 https://（DoH）地址，最多 8 条。推荐 IP 直连形式（如 https://94.140.14.14/dns-query）以免引导解析；域名形式会先经国内 DNS 解析。查询始终经代理出站。",
  "dns.remoteDnsInvalid": "仅支持 https://（DoH）地址：{v}",
  "dns.remoteDnsMax": "最多 8 条",
  "dns.hijack": "劫持 DNS",
  "dns.cache": "缓存",
  "dns.servers": "服务器",
  "dns.rules": "白名单 / 规则",
  ...
  "dns.coreRunning": "运行中",
  "dns.coreStopped": "未运行",
  "dns.leakRiskLocal": "泄露风险：系统 DNS（明文），查询可被运营商观测",
  "dns.leakRiskDomestic": "泄露风险：国内明文 UDP 解析，查询可被运营商观测",
  "dns.ipLabel": "IP 地址",
